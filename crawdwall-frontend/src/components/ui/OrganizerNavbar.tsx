          ...
          <div className="flex-1 overflow-y-auto p-4">
            <div className="space-y-2">
              <Link 
                ...
                onClick={() => setIsSidebarOpen(false)}
              >
                <span className="material-symbols-outlined text-sm mr-3">dashboard</span>
                Dashboard
              </Link>
              ...
              <Link 
                ...
                className={`w-full text-left px-4 py-3 rounded-lg transition-colors flex items-center ${
                  pathname === '/organizer/proposals/new' 
                    ? 'bg-primary/20 text-primary' 
                    : 'text-slate-400 hover:bg-white/5'
                }`}
                onClick={() => setIsSidebarOpen(false)}
              >
                <span className="material-symbols-outlined text-sm mr-3">add_circle</span>
                Submit Proposal
              </Link>
              ...
              <Link 
                ...
                onClick={() => setIsSidebarOpen(false)}
              >
                <span className="material-symbols-outlined text-sm mr-3">person</span>
                Profile
              </Link>
              <button 
                onClick={() => {
